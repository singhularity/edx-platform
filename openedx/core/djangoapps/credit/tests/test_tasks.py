...
class TestTaskExecution(ModuleStoreTestCase):
    ...
    def setUp(self):
        ...
        self.subsection2 = ItemFactory.create(
            parent=self.section, category='sequential', display_name='Test Subsection 2'
        )
    ...
    def test_proctored_exam_requirements(self):
        ...
        self.assertEqual(requirements[1]['name'], 'i4x://org.21/course_21/sequential/Test_Subsection_2')
